...
class NodeTree(object):
    def __init__(self, index = None, order_split_attribute = None,children = [], entropy = 0, high = 0):
        self.index = index           # index of data in this node
        self.entropy = entropy   # entropy, will fill later
        self.high = high       # distance to root node
        self.split_attribute = None # which attribute is chosen, it non-leaf
        self.order_split_attribute = order_split_attribute # which order of attribute is chosen, it non-leaf
